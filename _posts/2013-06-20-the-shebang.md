...
---
[The Unix shebang](https://en.wikipedia.org/wiki/Shebang_(Unix)) is
...
– it's actually [the kernel that interprets this line](https://lists.gnu.org/archive/html/bug-bash/2008-05/msg00052.html).  
...
The XNU (Mac OS X) kernel code parsing the shebang can be found [here](https://www.opensource.apple.com/source/xnu/xnu-1504.7.4/bsd/kern/kern_exec.c)
...
Running `./test` in [fish](https://fishshell.com/) gives the following error
...
<https://stevesmithbytes.blogspot.com/2011/02/handling-spaces-in-shebang-line-in-mac.html>
